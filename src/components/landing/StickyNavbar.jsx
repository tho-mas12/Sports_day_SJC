  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
        ...
        <a href="#home" className="flex items-center gap-3 group text-decoration-none shrink-0 relative">
          <img 
            src="/Img/logo_full.png" 
            alt="SJC Logo" 
            className="h-14 md:h-16 w-auto object-contain z-50 -my-2.5 drop-shadow-sm group-hover:scale-105 transition-transform duration-300"
          />
